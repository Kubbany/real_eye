...
import 'package:real_eye/Features/profile/presentation/widgets/profile_comments_list_view.dart';
...
class ProfileCommentsViewBody extends StatelessWidget {
  const ProfileCommentsViewBody({super.key, required this.post});
